...
pub struct PipeMessage {
    ...
    #[prost(enumeration="DeliveryHint", optional, tag="9")]
    pub delivery_hint: ::core::option::Option<i32>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Arg {
...
impl DeliveryHint {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            DeliveryHint::Unspecified => "Unspecified",
            DeliveryHint::FireAndForget => "FireAndForget",
            DeliveryHint::Durable => "Durable",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "FireAndForget" => Some(Self::FireAndForget),
